...
class ServicesTranslationOptions(TranslationOptions):
    fields = ('title', 'description', 'requirements',
              'installation_guide', 'usage_guidelines', 'constraints', )
...
translator.register(ServiceConfiguration,
                    ServiceConfigurationTranslationOptions)
...
translator.register(ServicesToTechnicalSupport,
                    ServicesToTechnicalSupportTranslationOptions)
...
class TermsUsageTranslationOptions(TranslationOptions):
    fields = ('content',)
translator.register(TermsUsage, TermsUsageTranslationOptions)

...
class LogoAdmin(admin.ModelAdmin):
    list_display    = ['id', 'title', 'logo', 'mime_type', 'absolute_path', 'logo_size', 'logo_dimensions', 'selected']
    ...
    def save_model(self, request, object, form, change):
        ...
        if object.selected:
            ...
            messages.add_message(request, messages.INFO, 'Logo ' + object.title + ' has been selected')
...
class FaviconAdmin(admin.ModelAdmin):
    pass
    list_display    = ['id', 'title', 'favicon', 'mime_type', 'absolute_path', 'favicon_size', 'favicon_dimensions', 'selected']
    list_filter     = ['selected',]
    ordering        = ['id',]
    ...
    def save_model(self, request, object, form, change):
        ...
        if object.selected:
            ...
            messages.add_message(request, messages.INFO, 'Favicon ' + object.title + ' has been selected')
        if not existSelectedLogo:            
            object.selected = True
        object.save()
...
class MetadataAdmin(admin.ModelAdmin):
    ...
    def save_model(self, request, object, form, change):
        ...
        if object.active:
            ...
            messages.add_message(request, messages.INFO, 'Meta elements for the application has been selected')
...
class ContactUsAdmin(admin.ModelAdmin):
    list_display = ['id', 'skype_id', 'skype_button_id', 'phone', 'email', 'address', 'active']
    list_filter = ['active',]
    ...
    def save_model(self, request, object, form, change):
        ...
        if object.active:
            ...
            messages.add_message(request, messages.INFO, 'Contact details for the application has been inserted')
...
class LanguageFlagAdmin(admin.ModelAdmin):
    list_display    = ['alias', 'flag', 'mime_type', 'absolute_path','flag_size','flag_dimensions']
    ordering        = ['alias']
...
class UserAdmin(admin.ModelAdmin):
    list_display        = ['id', 'username', 'name', 'lastname', 'gender', 'email', 'country', 'it_experience', 'is_active', 'registration']
    ...
    readonly_fields     = ['username', 'registration', 'last_login','email','mobile']
    ordering            = ['username', 'name', 'lastname']
    list_filter         = ['country', 'city', 'is_active', 'gender', 'experience__level', 'registration', 'last_login']
...
class ServiceAdmin(admin.ModelAdmin):
    ...
    fields = [('title', 'description'), ('image', 'is_public', 'is_visible'), 
        ('type', 'categories'), ('charging_policy', 'price', 'unit'), ('version', 'license'),
        'owner', ('requirements', 'installation_guide', 'usage_guidelines'),
        ('location_constraint', 'latitude', 'longitude', 'coverage'),
        'language_constraint', 'skype', ('created_date', 'modified_date')    
    ]
    readonly_fields = ['categories', 'created_date', 'modified_date', 'type', 'price', 'unit', 'charging_policy', 'owner']
...
class ProviderAdmin(admin.ModelAdmin):
    list_display        = ['id', 'user', 'is_active', 'crowd_fund_participation', 'crowd_fund_notification']
    fields              = ['user', ('is_active'), ('crowd_fund_participation', 'crowd_fund_notification'), 'company']
    readonly_fields     = ['user', 'company']
    ordering            = ['user']
    search_fields       = ['user__username', 'user__name', 'user__lastname',]
    list_filter         = ['is_active', 'crowd_fund_participation', 'crowd_fund_notification', 'company']
    list_display_links = []
...
class ConsumersAdmin(admin.ModelAdmin):
    list_display        = ['id', 'user', 'is_active', 'crowd_fund_participation', 'crowd_fund_notification']
    fields              = ['user', ('is_active'), ('crowd_fund_participation', 'crowd_fund_notification')]
...
class TopicAdmin(admin.ModelAdmin):
    list_display    = ['id', 'title', 'included_articles', 'created_date', 'modified_date', 'visible', 'protected']
    list_filter     = ['title', 'created_date', 'modified_date', 'visible', 'protected']
    ordering        = ['id']
    search_fields   = ['title', 'description', ]
    #date_hierarchy  = 'created_date'
    list_per_page   = 20
...
class AbstractArticleEntityAdmin(admin.ModelAdmin):
    ...
    list_display    = ['id', 'title', 'article_title', 'element', 'extension', 'published_date', 'visible', 'protected']
...
class ThemeAdmin(admin.ModelAdmin):
    list_display    = ['id', 'title', 'url', 'success_base', 'primary_base', 'info_base', 'warning_base', 'danger_base', 'radius', 'is_visible', 'is_default']
    fields          = [('title', 'is_visible', 'is_default'), 'url', 'success_base', 'primary_base', 'info_base', 'warning_base', 'danger_base', 'radius']
    ...
    def save_model(self, request, object, form, change):
        ...
        if object.is_default:
            ...
            messages.add_message(request, messages.SUCCESS, 'The default application\'s theme has been changed to ' + object.title + "!")
        if not defaultTheme:            
...
admin.site.register(ServicesToTechnicalSupport, TranslatedServicesToTechnicalSupportAdmin)
